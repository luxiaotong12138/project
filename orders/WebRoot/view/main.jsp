...
function self(value){
	if(value=="修改密码"){
		window.open("view/modifypsd.jsp",width=400,height=300);
...
<body>
	<div id="Container">
			...
			<div id="logo">
				...
				<table style="margin-left: 660px;width: 700px">
					...
					<!-- eq等于  ne不等于 -->
						...
						<td width="100px"><a style="color:orange;font-size: 20px;">${result}</a></td>
						<td><select id="self" name="self" style="background-color: #BE77FF; font-size: 15px;" onchange="self(this.value);">
						...
						<td width="100px"><a href="view/register.jsp">注册</a></td></c:if>
		...
		<div id="Content">
			...
			<tr><td><a>第<c:out value="${num}"></c:out>页</a></td></tr>
				</c:forEach>
