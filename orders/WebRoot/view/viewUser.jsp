...
<table class="table table-border table-bordered table-bg">
   ...
   <tr> <td><c:out value="${ui.id}"/></td>
    <td><c:out value="${ui.username}"/></td>
    <td><c:out value="${ui.birthday}"/></td>
    <td><c:out value="${ui.sex}"/></td>
   <td> <c:out value="${ui.address}"/></td>
   		<td class="Hui-iconfont"><a href='user/delete.do?id=<c:out value="${ui.id}"/>'>&#xe6e2;</a>
   		<a href='view/update.jsp?id=<c:out value="${ui.id}"/>' class="Hui-iconfont">&#xe6df;</a></td>
    </tr>
    </c:forEach>
		</tbody>
	</table>
